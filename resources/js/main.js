...
window.myApp = {
    ...
    openDocs: () => {
        Neutralino.app.open({ url: "https://neutralino.js.org/docs" });
    },
    openTutorial: () => {
        Neutralino.app.open({ url: "https://www.youtube.com/watch?v=txDlNNsgSh8&list=PLvTbqpiPhQRb2xNQlwMs0uVV0IN8N-pKj" });
    },
    setTray: () => {
        if(NL_MODE != "window") {
